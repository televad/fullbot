...
return "Voc锚 n茫o 茅 um Administrador."
end
...
return 'Descri莽茫o do grupo criada:\n\n'..deskripsi
end
--developed by @i9Dev
local function get_description(msg, data)
local data_cat = 'description'
if not data[tostring(msg.to.id)][data_cat] then
return 'O grupo n茫o tem uma descri莽茫o.'
end
...
if success == 0 then
return send_large_msg(receiver, "N茫o 茅 poss铆vel gerar link para este grupo.")
end
...
return 'O nome do grupo j谩 est谩 bloqueado.'
else
...
return 'O nome do grupo j谩 est谩 desbloqueado.'
else
...
return 'Os membros do grupo j谩 est茫o bloqueados.'
else
...
return 'Os membros do grupo n茫o est茫o bloqueados.'
else
data[tostring(msg.to.id)]['settings']['lock_member'] = 'Nao'
save_data(_configmoderation.data, data)
...
return 'A imagem do grupo j谩 est谩 bloqueada.'
else
...
return 'A imagem do grupo ainda n茫o foi bloqueada.'
else
...
local text = "馃敡 Configura莽玫es do grupo\n\n馃攼 Bloquear nome do grupo: "..settings.lock_name.."\n馃攼 Bloquear membros do grupo: "..settings.lock_member
return text
end

--lock/unlock spam protection
local function lock_group_spam(msg, data)
return 'Prote莽茫o Anti Flood foi habilitado'
end

local function unlock_group_spam(msg, data)
return 'Prote莽茫o Anti Flood foi desabilitado'
end
